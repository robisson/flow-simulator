...
export default class TaskManager {
  ...
  static create(date, resources, hourByDay) {
    return new TaskManager(date, resources, hourByDay);
  }

  updateTasksStatus(date) {
  ...
  allTasksDone() {
    ...
    return todoQueue.isEmpty() && doingQueue.isEmpty();
  }
}
